        ...
        <div class="content" id="top-players">
            ...
            <div class="content__body">
                    ...
                    <div class="left__block">
                        <a href="#">
                            <img class="item__img" src="../assets/img/player1-img.png" alt="player1-img.png"
                                loading="lazy">
                            <span class="item__title">John Smith</span>
                        </a>
                    </div>
                    <div class="right__block teams__action">
                        <div class="more-details show-hover">
                ...
                <div class="item">
                    <div class="left__block">
                        <a href="#">
                            <img class="item__img" src="../assets/img/player2-img.png" alt="player2-img.png"
                                loading="lazy">
                            <span class="item__title">Lara</span>
                        </a>
                    </div>
                    <div class="right__block teams__action">
                ...
                <div class="item">
                    <div class="left__block">
                        <a href="#">
                            <img class="item__img" src="../assets/img/player3-img.png" alt="player3-img.png"
                                loading="lazy">
                            <span class="item__title">Trevor</span>
                        </a>
                    </div>
                    <div class="right__block teams__action">
                        <div class="more-details">
